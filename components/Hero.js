  ...
  return (
    <section className="relative w-full min-h-[90vh] text-white overflow-hidden">
      ...
      <div className="relative z-10 px-8 md:px-20 pt-40 space-y-6">
        ...
        <p className="text-lg text-gray-200 max-w">
          Un espace pensé pour les créateurs indépendants, pour mettre en lumière leur style,
          leurs histoires et leurs pièces uniques.
        </p>
