    ...
    <header className="w-full bg-[#000000] overflow-x-hidden">
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-4 px-4 py-4 sm:flex-nowrap sm:px-10 sm:py-6">
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-4">
          ...
          {/* Panier */}
          <button className="p-1" aria-label="Panier">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 sm:h-6 sm:w-6"
              viewBox="0 0 24 24"
          ...
          <button
            className="ml-1 inline-flex items-center justify-center p-1 sm:hidden"
            aria-label="Menu"
      ...
      {open && (
        <div className="flex flex-col gap-2 border-t border-black/10 px-4 pb-4 pt-2 text-sm sm:hidden">
          ...
          <button className="px-2 py-1 text-left text-xs font-semibold tracking-[0.18em] text-white">
            CREATEURS
          </button>
      ...
      {/* LIGNE DU BAS : MENU DESKTOP */}
{/* LIGNE DU BAS : MENU DESKTOP (agrandi) */}
      <div className="hidden sm:grid w-full grid-cols-3 text-center pt-8 pb-10">

        <div>
          <button className="text-lg font-bold tracking-[0.18em] text-white font-poppins">
            CREATEURS
          </button>
        </div>
